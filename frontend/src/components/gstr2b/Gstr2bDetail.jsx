...
const Gstr2bDetail = ({ visible, onClose, invoice }) => {
    ...
    >
      <Descriptions bordered column={2} className="mb-6">
        ...
        <Descriptions.Item label="Supplier GSTIN" span={1}>
          <Tag color="blue">{invoice.supplierGstin}</Tag>
        </Descriptions.Item>
        <Descriptions.Item label="Buyer GSTIN" span={2}>
          <Tag color="green">{invoice.buyerGstin}</Tag>
        </Descriptions.Item>
        <Descriptions.Item label="Taxable Value" span={1}>
          <span className="font-medium">{formatCurrency(invoice.taxableValue)}</span>
        </Descriptions.Item>
        <Descriptions.Item label="Grand Total" span={1}>
        ...
        <Descriptions.Item label="IGST" span={2}>
      ...
      <div className="mt-4 text-sm text-gray-500">
        Uploaded on: {formatDate(invoice.uploadedAt)}
      </div>
    </Modal>
  );
};

export default Gstr2bDetail;